...
use \PropelException;
use \PropelPDO;
use Blog\Model\CategoryPeer;
use Blog\Model\PostPeer;
use Blog\Model\User;
use Blog\Model\UserPeer;
use Blog\Model\map\UserTableMap;
...
abstract class BaseUserPeer {
	...
	const OM_CLASS = 'Blog\\Model\\User';
	...
	protected static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Username', 'CreatedAt', 'UpdatedAt', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'username', 'createdAt', 'updatedAt', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::USERNAME, self::CREATED_AT, self::UPDATED_AT, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID', 'USERNAME', 'CREATED_AT', 'UPDATED_AT', ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'username', 'created_at', 'updated_at', ),
	...
	protected static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Username' => 1, 'CreatedAt' => 2, 'UpdatedAt' => 3, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'username' => 1, 'createdAt' => 2, 'updatedAt' => 3, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::USERNAME => 1, self::CREATED_AT => 2, self::UPDATED_AT => 3, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'USERNAME' => 1, 'CREATED_AT' => 2, 'UPDATED_AT' => 3, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'username' => 1, 'created_at' => 2, 'updated_at' => 3, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, )
	);
