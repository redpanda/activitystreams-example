...
use Blog\Model\map\CategoryTableMap;
...
abstract class BaseCategoryPeer {
	...
	const OM_CLASS = 'Blog\\Model\\Category';
	...
	protected static $fieldNames = array (
		...
		BasePeer::TYPE_COLNAME => array (self::ID, self::NAME, self::USER_ID, self::CREATED_AT, self::UPDATED_AT, ),
	...
	protected static $fieldKeys = array (
		...
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::NAME => 1, self::USER_ID => 2, self::CREATED_AT => 3, self::UPDATED_AT => 4, ),
	...
	public static function doCountJoinUser(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(CategoryPeer::USER_ID, UserPeer::ID, $join_behavior);
	...
	protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
	{
		...
		foreach ($objects as $obj) {
			...
			$criteria->add(PostPeer::CATEGORY_ID, $obj->getId());
