 ...
 */
abstract class BasePost extends BaseObject 
{

	/**
	 * Peer class name
	 */
	const PEER = 'Blog\\Model\\PostPeer';
	...
	public function setCategoryId($v)
	{
		...
		if ($this->category_id !== $v) {
			$this->category_id = $v;
			$this->modifiedColumns[] = PostPeer::CATEGORY_ID;
		}
	...
	protected function doInsert(PropelPDO $con)
	{
		...
		if ($this->isColumnModified(PostPeer::CATEGORY_ID)) {
