...
use Blog\Model\map\PostTableMap;
...
abstract class BasePostPeer {
	...
	const OM_CLASS = 'Blog\\Model\\Post';
	...
	public static function doCountJoinCategory(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(PostPeer::CATEGORY_ID, CategoryPeer::ID, $join_behavior);
	...
	/**
	 * Selects a collection of Post objects pre-filled with their Category objects.
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	 * @return     array Array of Post objects.
	...
	public static function doSelectJoinCategory(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Post) to $obj2 (Category)
				$obj2->addPost($obj1);
	...
	public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key3 !== null) {
				...
				// Add the $obj1 (Post) to the collection in $obj3 (Category)
				$obj3->addPost($obj1);
			} // if joined row not null
	...
	public static function doSelectJoinAllExceptUser(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if (null !== ($obj1 = PostPeer::getInstanceFromPool($key1))) {
				...
				// Add the $obj1 (Post) to the collection in $obj2 (Category)
				$obj2->addPost($obj1);
	...
	/**
	 * Selects a collection of Post objects pre-filled with all related objects except Category.
	 *
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
